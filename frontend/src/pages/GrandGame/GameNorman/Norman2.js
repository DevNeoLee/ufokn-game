                    ...
                    <div className="gameBlock">
                        ...
                        <div className="normanMapContainer">
                            ...
                            { role === 'NormanA' ?
                                ...
                                :
                              role === 'NormanB' ?
                                <div className="normanHouseB" onMouseEnter={handleMouseEnter5} onMouseLeave={handleMouseLeave5}><HouseFill /></div>
                                :
                              role === 'NormanC' ?    
                                <div className="normanHouseC" onMouseEnter={handleMouseEnter6} onMouseLeave={handleMouseLeave6}><HouseFill/></div>
                                :
                              role === 'NormanD' ?
                                <div className="normanHouseD" onMouseEnter={handleMouseEnter7} onMouseLeave={handleMouseLeave7}><HouseFill /></div>
                                :
                              role === 'NormanE' ?
                                <div className="normanHouseE" onMouseEnter={handleMouseEnter8} onMouseLeave={handleMouseLeave8}><HouseFill /></div>
                                :
                              role === 'NormanF' ?
                                <div className="normanHouseF" onMouseEnter={handleMouseEnter9} onMouseLeave={handleMouseLeave9}><HouseFill /></div>
                                :
                                null
                            }    
