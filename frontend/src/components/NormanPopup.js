...
export default function NormanPopup({ setPopup }) {
        ...
        <div className="">
            {transition2((style, item) =>
                <animated.div style={style} className="roleframe">
                    ...
                    <p> 1) Decide How much is the Risk for Evacuation out of the city</p>
                    <p>2) City Emergency Manager, Erica will send you an update message, please check her message carefully as well.</p>
